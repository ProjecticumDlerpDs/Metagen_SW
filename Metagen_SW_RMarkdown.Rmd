...
bash Kraken2_classifier.sh -i ~/Metagen_SW/bewerkte_data/combined_10_porechopped.fastq.gz -O ~/Metagen_SW/analyse/Kraken2/ -d /home/daur2/metagenomics/minikraken2_v2_8GB_201904_UPDATE/

```

<br>The script will save the results to the newly made analyse/Kraken2 folder. The "combined_10_porechopped.report" file shows the complete taxonomy of all reads in the input file, with representation in percentages (%) in the first column. The overall percentages of classified and unclassified ("U") reads can be seen in the first two lines of this document. 

```{bash, echo=TRUE, eval=TRUE}

cat analyse/Kraken2/combined_10_porechopped.report | head -n2
...
bracken -d /home/daur2/metagenomics/minikraken2_v2_8GB_201904_UPDATE/ -i ~/Metagen_SW/analyse/Kraken2/combined_10_porechopped.report -o ~/Metagen_SW/analyse/bracken/combined_10_porechopped.bracken
...
ktImportText -o Krona_output.html ~/Metagen/analyse/Bracken/combined_10_porechopped_bracken_species.report
...
![Figure 4: Krona pie chart visualization of bracken output "combined_10_porechopped_bracken_species.report" ](misc/Krona_combined_10.PNG)

...
###
CORRIGEREN:
deze cmd gebruiken voor goede resultaten:
ktImportTaxonomy -m 3 -t 5 [bracken].report -o krona.html
Human kan worden gemaskeerd met "#" voor elke human regel in bracken.report. Dat is nu gedaan voor testSW_pc_nh_bracken_species.report
###

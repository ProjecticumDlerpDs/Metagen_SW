...
subtitle: "for analyzing Oxford Nanopore Technologies’ MinION long-read, single-end, metagenomic shotgun sequencing data"
...
<br><br>**Chapter 8**: Pipeline overview and conclusions 
<br><br>**Chapter 9**: Considerations and improvements
...
Workflow positive control:

1: Preparation:
<br>1.1: NCBI https://www.ncbi.nlm.nih.gov/
<br>1.2: select database: SRA
<br>1.3: search "Escherichia coli O157:H7 nanopore"
<br>1.4: choose "WGS of Escherichia coli O157" with SRX4347297
<br>1.5: note run SRR7477813

2: Get data:
<br>2.1: fastq-dump SRR7477813
<br>2.2: mv SRR7477813.fastq control
<br>2.3: gzip control/SRR7477813.fastq
...
<br>        porechop -i control/SRR7477813_Q10/SRR7477813_Q10.fastq.gz -o control/SRR7477813_Q10_PC.fastq.gz
<br>      conda activate nanofilt_env
<br>        bash scripts/nanofilt_lfilter.sh -i control/SRR7477813_Q10/SRR7477813_Q10_PC.fastq.gz -O control
<br>        (option: min 5000; max none)
<br>      conda activate meta
<br>3.5: new kraken
<br>      bash scripts/kraken2_classifier.sh -i control/SRR7477813_Q10/SRR7477813_Q10_PC_L5000.fastq.gz -O analyse/kraken2/SRR7477813/SRR7477813_Q10_PC_L5000
<br>3.6: bracken
...
<br>3.7: krona
<br>      bash scripts/krona_visualizer.sh -i analyse/bracken/SRR7477813_Q10_PC_L5000/SRR7477813_Q10_PC_L5000_bracken_species.report -O analyse/krona/SRR7477813_Q10_PC_L5000
...
This pipeline has been created for analyzing microbial composition in metagenomic samples. It has been written for users with limited to no scripting or command line experience. The pipeline includes directory and conda environment setups, raw data selection, quality control, data manipulation based on intermediate results, taxonomic classification, and visualization.
